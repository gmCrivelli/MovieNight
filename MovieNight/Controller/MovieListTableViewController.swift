...
class MovieListTableViewController: UITableViewController {
    ...
    func registerForNotifications() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.loadMovies),
                                               name: NSNotification.Name(UNKeys.dataUpdate), object: nil)
    }
...
//            switch itemType {
//            case .list:
//                if let cell = tableView.dequeueReusableCell(withIdentifier: "releasesCell",
//                                                            for: indexPath) as? MovieReleasesTableViewCell {
...
//        }
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle,
        ...
        if editingStyle == .delete {
            guard let context = context, let movie = fetchedResultController?.object(at: indexPath) else { return }
